...
curl --header "Authorization: Bearer ${TOKEN}" --header "Content-Type: application/vnd.api+json" --request DELETE https://${TFE_SERVER}/api/v2/workspaces/${WORKSPACE_ID}/vars/${VAR_ID} 
